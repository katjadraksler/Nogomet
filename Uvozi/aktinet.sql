...
CREATE TABLE dogodek (
    id SERIAL PRIMARY KEY,
    id_uporabnika INTEGER REFERENCES uporabnik(id) NOT NULL,
...
CREATE TABLE udelezba (
    id_dogodka INTEGER REFERENCES dogodek(id) NOT NULL,
    id_uporabnik INTEGER REFERENCES uporabnik(id) NOT NULL,
    PRIMARY KEY (id_dogodka,id_uporabnik)
);
